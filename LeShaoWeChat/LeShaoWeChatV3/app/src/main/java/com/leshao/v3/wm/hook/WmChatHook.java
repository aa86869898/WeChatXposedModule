...
public class WmChatHook {
    ...
    public static void initOnAppStart(ClassLoader cl) {
        try {
            ...
            hookSendMsgMgrDebug();
            hookVideoSendDebug();
            LogWriter.log(TAG, "initOnAppStart OK v799 build=v421 2026-08-10");
        } catch (Throwable t) {
...
private static boolean sendVideoToUser(String toUser, String videoPath) {
        LogWriter.log(TAG, "v799 sendVideo ENTER: to=" + toUser + " path=" + videoPath);
        if (sCL == null) throw new RuntimeException("sCL null");
        ...
        LogWriter.log(TAG, "v799 sendVideo duration=" + duration + "s size=" + f.length());
        ...
        sH.post(() -> {
            try {
                ...
                LogWriter.log(TAG, "v799 sendVideo Cj main-thread ok to=" + finalToUser);
            } catch (Throwable t) {
                LogWriter.log(TAG, "v799 sendVideo Cj fail: " + t.getClass().getName() + ": " + t.getMessage());
            }
        });
        return true;
    }
